	...
	connectStartCmd := &grumble.Command{
		...
		Run: func(c *grumble.Context) error {
			...
			if server.IsWolfPackExec {
				...
				//status, err := startconnector(connectorID, rhost, rport, protocol, connectString)
				...
				err := core.StartConnector(connectorID, rhost, rport, protocol, requestType, command, query, connectString, path)
